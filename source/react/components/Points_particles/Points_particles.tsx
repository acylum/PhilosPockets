...
import json from "./Points_particles.json"

interface Props {

}

const Points_particles : React.FC<Props> = (props: Props) => {
    ...
    useEffect(() => {
        ...
        particleJson.emitters.forEach(emitter => {
            ...
            emitter.initializers.forEach(initializer => {
                ...
                if(initializer.type == 'BodySprite')
                {
                    if(props.texture !== undefined) initializer.properties.texture = props.texture;
                }
            });
...
export default Points_particles;